# Prepare the included character example
...
Unless I request a custom asset or integration, prepare the included armored-character example from `input/concept-art.png`.
...
- **My own asset:** When I provide a PNG or JPEG path, pass it with `--input`. Use CLI flags instead of changing the sample defaults.
